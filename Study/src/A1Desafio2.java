...
public class A1Desafio2 {
    ...
    public static void filmesPopulares() throws Exception {
        A1Desafio2.link = "https://raw.githubusercontent.com/alura-cursos/imersao-java-2-api/main/MostPopularMovies.json";
    ...
    public static void melhoresFilmes() throws Exception {
        A1Desafio2.link = "https://raw.githubusercontent.com/alura-cursos/imersao-java-2-api/main/TopMovies.json";
    ...
    public static void seriesPopulares() throws Exception {
        A1Desafio2.link = "https://raw.githubusercontent.com/alura-cursos/imersao-java-2-api/main/MostPopularTVs.json";
        var parser = new JsonParser();
        List<Map<String, String>> listaDeFilmes = parser.parse(retornarBody());
    ...
    public static void melhoresSeries() throws Exception {
        A1Desafio2.link = "https://raw.githubusercontent.com/alura-cursos/imersao-java-2-api/main/TopTVs.json";
        var parser = new JsonParser();
        List<Map<String, String>> listaDeFilmes = parser.parse(retornarBody());
